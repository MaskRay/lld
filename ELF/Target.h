...
// Tries to relax a toc-indirection. If an indirection can be safely relaxed
// this function performs the relaxation and returns true.
bool tryRelaxTocPPC64(RelType Type, const Relocation &Rel,
                      unsigned &TocRelIndex, uint8_t *BufLoc);

// In the PowerPC64 Elf V2 abi a function can have 2 entry points.  The first
// is a global entry point (GEP) which typically is used to intiailzie the TOC
