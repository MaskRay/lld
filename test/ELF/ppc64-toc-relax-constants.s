...
# Test we can perform toc-optimizations on .toc sections that contain more than
# symbol addresses (constants).
...
# address(default) - (.got+0x8000) = 0x10030000 - (0x10020090+0x8000) = 32624
# CHECK: nop
